...
public enum SpecialValueSet {
	...
	ZERO_TO_THOUSAND(forLoop(0, 1000)),
	ZERO_TO_MINUS_THOUSAND(forLoop(-1000, 0)),
	MINUS_TEN_TO_TEN(forLoop(-10, 10)),
	MINUS_TWENTY_TO_TWENTY(forLoop(-20, 20)),
	MINUS_HUNDRED_TO_HUNDRED(forLoop(-100, 100)),
	MINUS_THOUSAND_TO_THOUSAND(forLoop(-1000, 1000)),
	//power-of-10-sets
	...
	ALL(MINUS_THOUSAND_TO_THOUSAND, POW_10_PLUS_MINUS_ONE_WITH_HALVES, MIN_MAX_ALL_PLUS_MINUS_ONE_WITH_HALVES);
	;
