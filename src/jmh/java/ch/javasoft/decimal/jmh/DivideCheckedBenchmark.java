 ...
 */
public class DivideCheckedBenchmark extends AbstractBinaryOpIntLongRoundingBenchmark {
	...
	protected <S extends ScaleMetrics> long nativeDecimals(BenchmarkState state, Values<S> values) {
		try {
			return state.checkedArithmetics.divide(values.unscaled1, values.unscaled2);
		} catch (ArithmeticException e) {
			return 0;
		}
	}
