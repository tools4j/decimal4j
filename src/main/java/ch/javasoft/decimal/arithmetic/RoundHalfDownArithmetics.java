...
public class RoundHalfDownArithmetics extends
	 ...
	 */
	public RoundHalfDownArithmetics(int scale) {
	 ...
	 *             if scale is negative
	 */
	public RoundHalfDownArithmetics(Scale scale) {
		this(scale.getFractionDigits());
	}

	@Override
	public DecimalArithmetics derive(int scale) {
		return scale == getScale() ? this : new RoundHalfDownArithmetics(scale);
	}
